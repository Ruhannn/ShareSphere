    ...
    <section className="py-6 dark:text-[#ffffffd6]">
      <div className="container flex flex-col items-center justify-center p-4 mx-auto space-y-8 sm:p-10">
        ...
        <p className="max-w-2xl text-center dark:text-gray-400">
          Get to know the awesome people behind our projects! They're dedicated
          to making things happen, always ready to tackle challenges and turn
          them into opportunities. You'll love working with our team!
        </p>
        <div className="flex flex-row flex-wrap-reverse justify-center">
          {data.map((member, index) => (
            <div
              ...
              <img
                alt=""
                className="self-center object-cover flex-shrink-0 w-24 h-24 mb-4 rounded-full dark:bg-gray-500"
                src={member.avatar}
              />
